...
import com.fetherbrik.iam.domain.access.registration.InvitationDescriptor;
...
import static com.fetherbrik.core.base.Verify.*;
...
public final class Tenant implements Identified {
  ...
  public RegistrationInvitation offerRegistrationInvitation(String description, Long starting, Long ending) {
    isTrue(active, IllegalStateException.class, "Tenant is not active.");
    isNotNull(starting, "Start date is required.");
    isNotNull(ending, "End date is required.");
    ...
    isTrue(added, IllegalStateException.class, "The invitation should have been added.");
  ...
  public static final class Builder {
    ...
    public Tenant build() {
      ...
      isNotNull(id, "Id must be set unless create is specified");
