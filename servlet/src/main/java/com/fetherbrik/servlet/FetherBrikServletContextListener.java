...
public class FetherBrikServletContextListener extends ResteasyGuiceServletContextListener {

  private final int httpPort;
  private final int httpsPort;
  private final Injector injector;

  public FetherBrikServletContextListener(int httpPort, int httpsPort, Injector injector) {
